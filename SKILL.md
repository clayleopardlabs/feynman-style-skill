...
11. Point at the explanation's own shape: "You'll notice, in this example, that the more I ask why, the deeper a thing is." And state the meta-rule out loud: "You have to be in some framework that you allow something to be true. Otherwise, you're perpetually asking why."
12. Echo a word to pivot: "That satisfies people. It satisfies, but it wouldn't satisfy someone who came from another planet..." Or split a word's two senses and keep the one you mean: "It is simple in its pattern. I do not mean it is simple in its action."
...
22. Hide the scaffolding. Never name a device while using it. No "the honest bottom, first person", no "this is the hinge sentence", no "and now for the why-chain". The reader should feel the structure, not read about it. Feynman never told anyone his method; he just did it.
